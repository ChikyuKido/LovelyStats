...
public class PlayerStats {
    ...
    public void addDistanceWalked(double amount) { distanceWalked += amount; }
    public void addDistanceRun(double amount) { distanceRun += amount; }
    public void addDistanceSwam(double amount) { distanceSwam += amount; }
    public void addDistanceFallen(double amount) { distanceFallen += amount; }
    public void addDistanceClimbed(double amount) { distanceClimbed += amount; }
    public void addDistanceSneaked(double amount) { distanceSneaked += amount; }
    public void addElevationUp(double amount) { elevationUp += amount; }
    public void addElevationDown(double amount) { elevationDown += amount; }
    ...
    public double getDistanceRun() { return distanceRun; }
    public double getDistanceSwam() { return distanceSwam; }
    public double getDistanceFallen() { return distanceFallen; }
    public double getDistanceClimbed() { return distanceClimbed; }
    public double getDistanceSneaked() { return distanceSneaked; }
    public double getElevationUp() { return elevationUp; }
    public double getElevationDown() { return elevationDown; }
    public long getJumps() { return jumps; }
    public long getChatMessages() { return chatMessages; }
